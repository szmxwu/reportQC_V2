...
急诊报告：
与2023/5/17日片比较:
    右侧基底节区-背侧丘脑可见不规则形高密度病灶，约为43mm×35mm，CT值约68Hu，出血量约22ml，周围低密度水肿带同前相仿。脑室内积血较前范围进展，其中左侧脑室前角积血较前增多；中线结构左偏约8mm。余脑实质内未见明显异常。脑池、脑裂未见增宽。颅骨未见异常。

        """,
   ConclusionStr = """
急诊报告：
右侧基底节区-背侧丘脑出血并破入脑室内；左侧脑室前角积血较前增多；中线结构左偏；请结合临床随访复查。
